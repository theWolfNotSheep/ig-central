...
export const helpSections: HelpSection[] = [
    ...
    // ── Governance Framework ──────────────────────────
    {
        ...
        content: [
            ...
            { type: "heading", text: "Taxonomy Categories" },
            { type: "paragraph", text: "The taxonomy is a hierarchical tree of document categories. The AI classifies documents into the most specific applicable category. Categories can have keywords, a default sensitivity, and linked retention schedules." },
            ...
            { type: "paragraph", text: "Define how long documents of each type must be kept. When a document's retention period expires, the configured disposition action (delete, archive, review, anonymise) is triggered automatically." },
    ...
    // ── Admin: User Management ────────────────────────
    {
        ...
        category: "admin",
        icon: "Users",
        summary: "Creating users, assigning roles, setting clearance levels, and managing access.",
        content: [
            { type: "paragraph", text: "Administrators manage user accounts, role assignments, taxonomy access grants, and sensitivity clearance levels." },
            { type: "heading", text: "Creating Users" },
            { type: "steps", items: [
                "Go to **Users** in the admin section.",
                "Click **Create User** and fill in the details.",
                "Assign roles that determine what features the user can access.",
                "Set a sensitivity clearance level (0-3) to control which classified documents they can view.",
            ]},
            { type: "heading", text: "Roles & Permissions" },
            { type: "paragraph", text: "Roles bundle permissions together. Each permission maps to a specific feature (e.g., CAN_UPLOAD_DOCUMENTS, CAN_VIEW_ANALYTICS). Never check role names directly — always check permission keys." },
            { type: "heading", text: "Taxonomy Access Control" },
            { type: "paragraph", text: "Grant users access to specific taxonomy categories. Access is inherited — granting access to a parent category automatically grants access to all children. This provides three-layer access control:" },
            { type: "list", items: [
                "**Permission layer** — role-based feature access (can upload, can review, etc.).",
                "**Taxonomy layer** — which categories the user can see documents from.",
