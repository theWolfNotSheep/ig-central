...
import {
    Plus, Pencil, Shield, ShieldCheck, Lock,
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="bg-gray-50 border-b border-gray-200">
                                    ...
                                    <ResizableTh className="text-right px-4 py-3 font-medium text-gray-600 w-12">{" "}</ResizableTh>
                                </tr>
                            </thead>
                                ...
                                {filtered.map(u => (
                                    <tr key={u.id} onClick={() => router.push(`/admin/users/${u.id}`)}
                                        ...
                                        <td className="px-4 py-3 text-right">
                                            <ChevronRight className="inline size-4 text-gray-400" />
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
