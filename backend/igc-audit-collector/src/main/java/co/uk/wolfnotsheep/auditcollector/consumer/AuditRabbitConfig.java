 ...
 * {@code igc.audit} topic exchange — see
...
public class AuditRabbitConfig {
    ...
    public static final String EXCHANGE = "igc.audit";
    public static final String QUEUE_TIER1 = "igc.audit.tier1.collector";
    public static final String QUEUE_TIER2 = "igc.audit.tier2.collector";
