...
class MetaControllerTest {
    ...
    void capabilities_advertise_both_tiers() {
        MetaController controller = new MetaController("igc-audit-collector", "1.2.3");

        GetCapabilities200Response body = controller.getCapabilities().getBody();

        assertThat(body.getService()).isEqualTo("igc-audit-collector");
    ...
    void health_returns_UP_with_200() {
        MetaController controller = new MetaController("igc-audit-collector", "0.0.1");
