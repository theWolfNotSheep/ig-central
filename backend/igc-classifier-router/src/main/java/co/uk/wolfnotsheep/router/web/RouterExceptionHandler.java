...
public class RouterExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleBertBlockUnknown(BertBlockUnknownException e) {
        return problem(HttpStatus.UNPROCESSABLE_ENTITY, "ROUTER_BERT_BLOCK_UNKNOWN",
                "BERT block coords did not resolve at igc-bert-inference", e.getMessage());
    }
    ...
    public ResponseEntity<ProblemDetail> handleSlmBlockUnknown(SlmBlockUnknownException e) {
        return problem(HttpStatus.UNPROCESSABLE_ENTITY, "ROUTER_SLM_BLOCK_UNKNOWN",
                "PROMPT block coords did not resolve at igc-slm-worker", e.getMessage());
    }
    ...
    public ResponseEntity<ProblemDetail> handleLlmBlockUnknown(LlmBlockUnknownException e) {
        return problem(HttpStatus.UNPROCESSABLE_ENTITY, "ROUTER_LLM_BLOCK_UNKNOWN",
                "PROMPT block coords did not resolve at igc-llm-worker", e.getMessage());
    }
