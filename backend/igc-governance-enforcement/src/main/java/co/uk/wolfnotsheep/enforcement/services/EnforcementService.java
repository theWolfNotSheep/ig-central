...
public class EnforcementService {
    ...
    private void migrateStorageTier(DocumentModel doc) {
        ...
        String destBucket = "igc-" + targetTier.getName().toLowerCase().replace(" ", "-");
