---
title: gls-classifier-router
lifecycle: forward
---

# gls-classifier-router
...
- **Phase 1.4** — `gls-bert-inference` first tier.
- **Phase 1.5** — `gls-slm-worker` middle tier.
- **Phase 1.6** — `gls-llm-worker` rework.
