...
class MetaControllerTest {
    ...
    void capabilities_advertises_service_identity_and_MOCK_tier() {
        MetaController controller = new MetaController("gls-classifier-router", "0.0.1-SNAPSHOT");
        ...
        assertThat(body.getService()).isEqualTo("gls-classifier-router");
    ...
    void health_returns_UP() {
        MetaController controller = new MetaController("gls-classifier-router", "0.0.1");
