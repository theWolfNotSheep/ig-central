...
public class ExtractMetrics {
    ...
    private static final String CASCADE_STEPS = "gls_router_classify_cascade_steps";
    private static final String TIER_STEP_DURATION = "gls_router_classify_tier_step_duration_seconds";
