...
class OutboxRelayTest {
    ...
    void system_tier_publishes_with_tier2_routing_and_marks_published() {
        ...
        verify(rabbitTemplate).send(eq("gls.audit"), eq("audit.tier2.DOCUMENT_CLASSIFIED"), any(Message.class));
    ...
    void domain_tier_strips_content_to_sha256_and_publishes_with_tier1_routing() {
        ...
        verify(rabbitTemplate).send(eq("gls.audit"), eq("audit.tier1.DOCUMENT_CLASSIFIED"), any(Message.class));
