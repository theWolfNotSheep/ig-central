 ...
 * {@code gls.platform.audit.relay.enabled} is not set to {@code false}.
...
public class PlatformAuditAutoConfiguration {
    ...
    @ConditionalOnMissingBean(name = "glsAuditExchange")
    public TopicExchange glsAuditExchange(OutboxRelayProperties properties) {
