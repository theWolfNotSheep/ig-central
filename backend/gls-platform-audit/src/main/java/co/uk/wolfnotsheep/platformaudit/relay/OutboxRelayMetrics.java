...
public class OutboxRelayMetrics {
    ...
    private static final String PUBLISH_RESULT = "gls_audit_relay_publish_total";
    private static final String PUBLISH_DURATION = "gls_audit_relay_publish_duration_seconds";
    private static final String QUEUE_DEPTH = "gls_audit_relay_pending_depth";
