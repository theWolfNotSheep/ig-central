...
class MetaControllerTest {
    ...
    void capabilities_advertises_service_identity_and_default_tier() {
        MetaController controller = new MetaController("igc-extraction-tika", "0.0.1-SNAPSHOT");
        ...
        assertThat(body.getService()).isEqualTo("igc-extraction-tika");
    ...
    void health_returns_UP() {
        MetaController controller = new MetaController("igc-extraction-tika", "0.0.1");
