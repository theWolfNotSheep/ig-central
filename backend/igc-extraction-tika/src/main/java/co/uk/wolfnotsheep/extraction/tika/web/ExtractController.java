...
public class ExtractController implements ExtractionApi {
    ...
    public ExtractController(
            ...
            @Value("${igc.extraction.tika.inline-byte-ceiling:262144}") long inlineByteCeiling,
            @Value("${spring.application.name:igc-extraction-tika}") String serviceName,
            @Value("${igc.extraction.build.version:0.0.1-SNAPSHOT}") String serviceVersion,
