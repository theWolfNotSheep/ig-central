 ...
 * idempotency — same shape as {@code gls-classifier-router},
 * {@code gls-extraction-audio} and {@code gls-slm-worker}.
 *
...
public class EnforceController implements EnforceApi {
    ...
    private EnforceResponse doEnforce(EnforceRequest request) {
        ...
        // auditEventId left null in PR2 — gls-platform-audit integration lands later
