...
class MetaControllerTest {
    ...
    void capabilities_advertises_enforcement_tier_and_service_metadata() {
        MetaController controller = new MetaController("gls-enforcement-worker", "1.2.3");

        GetCapabilities200Response body = controller.getCapabilities().getBody();

        assertThat(body.getService()).isEqualTo("gls-enforcement-worker");
    ...
    void health_returns_UP_with_200() {
        MetaController controller = new MetaController("gls-enforcement-worker", "0.0.1");
