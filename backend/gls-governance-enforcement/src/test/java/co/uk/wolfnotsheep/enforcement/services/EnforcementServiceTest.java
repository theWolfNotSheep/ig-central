...
class EnforcementServiceTest {
    ...
    void enforce_appliesGovernanceAndSetsRetentionAndStorageTier() {
        ...
        doc.setStorageBucket("gls-default");
        ...
        when(objectStorage.exists("gls-standard", "files/doc-1.pdf")).thenReturn(true);
        ...
        verify(objectStorage).copy("gls-default", "files/doc-1.pdf", "gls-standard", "files/doc-1.pdf");
        assertThat(result.getStorageBucket()).isEqualTo("gls-standard");
