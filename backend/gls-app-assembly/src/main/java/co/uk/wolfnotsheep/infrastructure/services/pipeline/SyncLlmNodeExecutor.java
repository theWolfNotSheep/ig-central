 ...
 *
 * This keeps all LLM infrastructure (Spring AI, Anthropic, MCP) in gls-llm-orchestration
 * while allowing gls-app-assembly's execution engine to call it synchronously via HTTP.
 */
@Service
