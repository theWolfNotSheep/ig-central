...
/**
 * Synchronous HTTP client to {@code gls-classifier-router}'s
 ...
 * {@code gls.router.cascade.llm.timeout} (default 60s) plus the
...
public class ClassifierRouterClient {
    ...
    public ClassifierRouterClient(
            @Value("${pipeline.classifier-router.url:http://gls-classifier-router:8080}") String baseUrl,
