 ...
 * and the LLM worker — observers can join the cascade-internal LLM
 * tier calls into the same trace. {@code eventType=LLM_*} discriminates
 * LLM-tier emissions from BERT and SLM emissions.
 */
public final class LlmEvents {

    public static final String EVENT_TYPE_COMPLETED = "LLM_COMPLETED";
    public static final String EVENT_TYPE_FAILED = "LLM_FAILED";
