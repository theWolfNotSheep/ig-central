 ...
 * CSV #47. Same shape as {@code igc-classifier-router} /
 * {@code igc-slm-worker} / {@code igc-enforcement-worker} — lifted
...
public class JobStore {
    ...
    public JobStore(
            JobRepository repo,
            @Value("${igc.indexing.worker.jobs.ttl:PT24H}") Duration ttl) {
        this.repo = repo;
        this.ttl = ttl;
    }
