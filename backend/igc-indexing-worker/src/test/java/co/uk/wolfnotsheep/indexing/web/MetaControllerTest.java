...
class MetaControllerTest {
    ...
    void capabilities_advertise_indexing_tier() {
        MetaController controller = new MetaController("igc-indexing-worker", "1.2.3");

        GetCapabilities200Response body = controller.getCapabilities().getBody();

        assertThat(body.getService()).isEqualTo("igc-indexing-worker");
    ...
    void health_returns_UP_with_200() {
        MetaController controller = new MetaController("igc-indexing-worker", "0.0.1");
