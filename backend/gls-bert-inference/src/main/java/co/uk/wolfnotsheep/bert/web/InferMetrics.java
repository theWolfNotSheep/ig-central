...
public class InferMetrics {
    ...
    private static final String DURATION = "gls_bert_infer_duration_seconds";
    private static final String RESULT = "gls_bert_infer_result_total";
    private static final String BYTES = "gls_bert_infer_bytes_processed";
