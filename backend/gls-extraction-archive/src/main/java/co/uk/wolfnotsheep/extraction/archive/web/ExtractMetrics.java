...
public class ExtractMetrics {
    ...
    private static final String EXTRACT_DURATION = "gls_archive_duration_seconds";
    private static final String EXTRACT_RESULT = "gls_archive_result_total";
    private static final String CHILD_COUNT = "gls_archive_children";
    private static final String BYTES_PROCESSED = "gls_archive_bytes_processed";
