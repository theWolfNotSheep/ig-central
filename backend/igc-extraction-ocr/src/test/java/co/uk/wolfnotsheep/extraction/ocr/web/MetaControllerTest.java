...
import co.uk.wolfnotsheep.extraction.ocr.api.MetaApi;
import co.uk.wolfnotsheep.extraction.ocr.model.GetCapabilities200Response;
import co.uk.wolfnotsheep.extraction.ocr.model.HealthResponse;
...
class MetaControllerTest {
    ...
    void capabilities_advertises_service_identity_and_default_tier() {
        MetaController controller = new MetaController("igc-extraction-ocr", "0.0.1-SNAPSHOT");
        ...
        assertThat(body.getService()).isEqualTo("igc-extraction-ocr");
    ...
    void health_returns_UP() {
        MetaController controller = new MetaController("igc-extraction-ocr", "0.0.1");
