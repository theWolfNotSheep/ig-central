...
public class ExtractMetrics {
    ...
    private static final String EXTRACT_DURATION = "igc_ocr_duration_seconds";
    private static final String EXTRACT_RESULT = "igc_ocr_result_total";
    private static final String BYTES_PROCESSED = "igc_ocr_bytes_processed";
    ...
    public void recordSuccess(Timer.Sample sample, String sourceBucket, String detectedMime, long byteCount) {
        Tags tags = Tags.of(
    ...
    private static String mimeFamily(String mime) {
        if (mime == null || mime.isBlank()) return "unknown";
