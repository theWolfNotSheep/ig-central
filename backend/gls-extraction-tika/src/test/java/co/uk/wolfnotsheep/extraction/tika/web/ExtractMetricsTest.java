...
class ExtractMetricsTest {
    ...
    void success_records_duration_and_counter_with_mime_family() {
        ...
        double counterCount = registry.counter("gls_extraction_result_total", Tags.of(
                Tag.of("outcome", "success"),
                Tag.of("source", "uploads"),
                Tag.of("mime_family", "application"))).count();
        long timerCount = registry.timer("gls_extraction_duration_seconds", Tags.of(
                Tag.of("outcome", "success"),
                Tag.of("source", "uploads"),
                Tag.of("mime_family", "application"))).count();
    ...
    void failure_records_with_error_code_tag() {
        ...
        assertThat(registry.counter("gls_extraction_result_total", Tags.of(
