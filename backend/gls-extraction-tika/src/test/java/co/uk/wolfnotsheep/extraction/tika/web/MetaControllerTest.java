...
class MetaControllerTest {
    ...
    void capabilities_advertises_service_identity_and_default_tier() {
        MetaController controller = new MetaController("gls-extraction-tika", "0.0.1-SNAPSHOT");
        ...
        assertThat(body.getService()).isEqualTo("gls-extraction-tika");
    ...
    void health_returns_UP() {
        MetaController controller = new MetaController("gls-extraction-tika", "0.0.1");
