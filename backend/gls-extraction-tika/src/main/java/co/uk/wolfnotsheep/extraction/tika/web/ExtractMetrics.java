...
public class ExtractMetrics {
    ...
    private static final String EXTRACT_DURATION = "gls_extraction_duration_seconds";
    private static final String EXTRACT_RESULT = "gls_extraction_result_total";
    ...
    public void recordByteCount(long byteCount) {
        registry.summary("gls_extraction_bytes_processed").record(byteCount);
    }
    ...
    public void recordDuration(String outcome, Duration duration) {
        registry.timer("gls_extraction_duration_seconds", Tags.of(Tag.of("outcome", outcome)))
                .record(duration);
    }
