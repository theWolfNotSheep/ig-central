...
import co.uk.wolfnotsheep.auditcollector.api.MetaApi;
...
public class MetaController implements MetaApi {
    ...
    public MetaController(
            @Value("${spring.application.name:gls-audit-collector}") String serviceName,
            @Value("${gls.audit.collector.build.version:0.0.1-SNAPSHOT}") String serviceVersion) {
    ...
    public ResponseEntity<GetCapabilities200Response> getCapabilities() {
        ...
        body.setTiers(List.of("AUDIT_TIER_1", "AUDIT_TIER_2"));
