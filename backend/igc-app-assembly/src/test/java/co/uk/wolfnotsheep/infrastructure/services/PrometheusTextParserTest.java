...
class PrometheusTextParserTest {
    ...
    void parsesLabelledMetricWithMultipleSamples() {
        String body = """
                # HELP igc_router_classify_result_total Router classification outcomes
                # TYPE igc_router_classify_result_total counter
                igc_router_classify_result_total{outcome="success",tier="BERT"} 142.0
                igc_router_classify_result_total{outcome="success",tier="LLM"} 38.0
                igc_router_classify_result_total{outcome="failure",tier="BERT"} 2.0
                """;
        List<PrometheusTextParser.Sample> samples =
                PrometheusTextParser.parse(body, Set.of("igc_router_classify_result_total"));
