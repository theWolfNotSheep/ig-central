...
/**
 * Read-only HTTP client to {@code igc-audit-collector}'s {@code /v1/events}
...
public class AuditCollectorClient {
    ...
    public AuditCollectorClient(
            @Value("${igc.audit.collector.url:http://igc-audit-collector:8080}") String baseUrl,
            @Value("${igc.audit.collector.timeout-ms:10000}") int timeoutMs) {
