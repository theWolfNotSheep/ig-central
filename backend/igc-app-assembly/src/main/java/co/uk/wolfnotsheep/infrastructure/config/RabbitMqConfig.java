 ...
 * {@code igc.rabbit.quorum-queues.enabled=true}. Quorum queues are
...
public class RabbitMqConfig {
    ...
    public static final String DLX_EXCHANGE = "igc.documents.dlx";
    ...
    public static final String QUEUE_CLASSIFIED = "igc.documents.classified";
    public static final String QUEUE_DLQ = "igc.documents.dlq";

    // ── Pipeline async queues ───────────────────────────
    public static final String PIPELINE_EXCHANGE = "igc.pipeline";
    public static final String QUEUE_LLM_JOBS = "igc.pipeline.llm.jobs";
    public static final String QUEUE_LLM_COMPLETED = "igc.pipeline.llm.completed";
    public static final String QUEUE_PIPELINE_RESUME = "igc.pipeline.resume";
    public static final String QUEUE_PIPELINE_DLQ = "igc.pipeline.dlq";
