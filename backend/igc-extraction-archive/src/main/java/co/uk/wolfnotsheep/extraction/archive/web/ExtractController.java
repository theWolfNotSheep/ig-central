...
public class ExtractController implements ExtractionApi {
    ...
    public ExtractController(
            ...
            @Value("${igc.extraction.archive.caps.max-archive-bytes:1073741824}") long maxArchiveBytes,
            @Value("${igc.extraction.archive.caps.max-children:5000}") int maxChildren,
            @Value("${igc.extraction.archive.caps.max-child-bytes:268435456}") long maxChildBytes,
            @Value("${spring.application.name:igc-extraction-archive}") String serviceName,
            @Value("${igc.extraction.archive.build.version:0.0.1-SNAPSHOT}") String serviceVersion,
