 ...
 *         and the {@code gls.config} {@link TopicExchange} only register
...
public class PlatformConfigAutoConfiguration {
    ...
    @ConditionalOnMissingBean(name = "glsConfigExchange")
    public TopicExchange glsConfigExchange() {
        return new TopicExchange("gls.config", true, false);
    }
