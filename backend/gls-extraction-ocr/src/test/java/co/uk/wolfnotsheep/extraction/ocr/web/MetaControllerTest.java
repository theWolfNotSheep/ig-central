...
class MetaControllerTest {
    ...
    void capabilities_advertises_service_identity_and_default_tier() {
        MetaController controller = new MetaController("gls-extraction-ocr", "0.0.1-SNAPSHOT");
        ...
        assertThat(body.getService()).isEqualTo("gls-extraction-ocr");
    ...
    void health_returns_UP() {
        MetaController controller = new MetaController("gls-extraction-ocr", "0.0.1");
