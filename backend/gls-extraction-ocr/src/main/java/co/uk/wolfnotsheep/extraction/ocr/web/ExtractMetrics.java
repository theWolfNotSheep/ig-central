...
public class ExtractMetrics {
    ...
    private static final String EXTRACT_DURATION = "gls_ocr_duration_seconds";
    private static final String EXTRACT_RESULT = "gls_ocr_result_total";
    private static final String BYTES_PROCESSED = "gls_ocr_bytes_processed";
