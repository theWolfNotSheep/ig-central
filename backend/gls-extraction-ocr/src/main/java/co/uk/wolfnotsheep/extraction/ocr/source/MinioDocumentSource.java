...
/**
 * MinIO-backed {@link DocumentSource}. Mirrors the Tika service's
 * source layer; maps SDK errors to our domain exceptions so the
 * controller can translate to RFC 7807.
 */
