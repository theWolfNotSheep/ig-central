...
public class ExtractMetrics {
    ...
    private static final String EXTRACT_DURATION = "gls_audio_duration_seconds";
    private static final String EXTRACT_RESULT = "gls_audio_result_total";
    private static final String BYTES_PROCESSED = "gls_audio_bytes_processed";
